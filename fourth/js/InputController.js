...
export class InputController {
    ...
    setup(){
        ...
        this.game.canvas_element.ontouchstart = this.on_touch_start.bind(this);
        this.game.canvas_element.ontouchmove = this.on_touch_move.bind(this);
        this.game.canvas_element.ontouchend = this.on_touch_end.bind(this);
